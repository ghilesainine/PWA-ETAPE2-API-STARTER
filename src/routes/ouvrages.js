...
import * as controller from '../controllers/ouvrages.js';
import * as aviscontroller from '../controllers/avis.js';
import { verifyJWT, requireRoles, ROLES } from '../middleware/auth.js';

export const router = Router();

// Exemples d'endpoints — à compléter dans controllers/ouvrages.js
...
router.post('/:id/avis', verifyJWT, aviscontroller.create);